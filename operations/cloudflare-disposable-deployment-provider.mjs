...
function loadMigrations(executionPins) {
  ...
  if (migrations.length !== 48 || migrations.at(-1)?.version !== 48 ||
...
export function prepareCloudflareDisposableProvisioningProvider(
  ...
  // that later supplies A2/A4 and schema 48, even though the A1/A3 bootstrap
  ...
  const createMutationProvider = async () => {
    ...
    const readCompletedSourceSchema = async (query, evidence) => {
      ...
      if (counts.migrations !== migrationSet.migrations.length || counts.schema_version !== 48 ||
    ...
    const readFinal = async ({
      ...
      if (checkedRole === "source") {
        ...
        if (counts.migrations !== 48 || counts.schema_version !== 48 ||
            counts.documents !== 0 || counts.chunks !== 0 || counts.fts !== 0 ||
      ...
      return immutable({
        semantic: {
          ...
          schema_version: checkedRole === "source" ? 48 : null,
