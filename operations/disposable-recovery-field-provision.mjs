...
function validateFinalSemantic(value, binding) {
  ...
  if (!exactKeys(value, keys) || value.account_id !== binding.account_id ||
      ...
      binding.role === "source" && (value.schema_version !== 48 || value.user_tables !== null) ||
  ...
  try {
    ...
    if (role === "source") {
      schema = await journalMutation({
        ...
        request: { action: "A1", database_id: d1.database_id, schema_version: 48,
    ...
    if (
        ...
        role === "source" && (first.semantic.schema_version !== 48 ||
          schema?.schema_version !== 48) ||
