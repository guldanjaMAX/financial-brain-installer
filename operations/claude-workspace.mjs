...
- Open Optimize with exactly one goal question: "What would you most like your Financial Brain to help you understand or keep current?" Let the owner answer, say "not sure," or skip it. Then keep the audit read-only.
