...
const FIELD_GATES = Object.freeze([
  ...
  Object.freeze({ id: "disposable_cloudflare", title: "Disposable Cloudflare Brain", proof: "With separate approval, prove browser OAuth, exact account choice, D1 and Vectorize creation through schema 48, fixed public smoke, one interrupted migration, vector backlog and drain, then confirm cleanup." }),
