...
export const POST_LAUNCHER_TEST_COMMANDS = Object.freeze([
  ...
  "node --test test/disposable-recovery-field-deploy.test.mjs",
  "node --test test/disposable-recovery-deployment-journal.test.mjs",
  "node --test test/disposable-recovery-field-deploy-cli.test.mjs",
  "node --test test/disposable-recovery-field-keychain-prep.test.mjs",
  "node --test test/disposable-recovery-field-keychain-prep-cli.test.mjs",
  "node --test test/cloudflare-disposable-deployment-provider.test.mjs",
  "node --test test/cloudflare-disposable-deployment-transport.test.mjs",
  "node --test test/disposable-recovery-target-eval.test.mjs",
  "node --test test/disposable-recovery-target-eval-cli.test.mjs",
  "node --test test/disposable-recovery-field-teardown.test.mjs",
  "node --test test/disposable-recovery-field-closeout.test.mjs",
  "node --test test/disposable-recovery-field-closeout-cli.test.mjs",
  "node --test test/v048-disposable-campaign-contract.test.mjs",
  "node --test test/v048-exclusive-resource-custody-contract.test.mjs",
  "node --test test/v048-worker-reference-contract.test.mjs",
  "node --test test/v048-vectorize-mutation-quiescence-contract.test.mjs",
  "node --test test/v048-d1-deletion-state-contract.test.mjs",
  "node --test test/v048-target-eval-immutability-contract.test.mjs",
  "node --test test/v048-teardown-d1-content-proof.test.mjs",
  "node --test test/disposable-recovery-field-seed.test.mjs",
  "node --test test/private-aggregate-receipt.test.mjs",
  "node --test test/recovery-content-fingerprint.test.mjs",
  ...
  "node --no-warnings --test worker/test/source-inventory-scale.test.mjs",
  ...
  "node --no-warnings --test test/aggregate-field-observer.test.mjs",
  ...
  "node --no-warnings --test test/source-original-accepted-resolution-migration.test.mjs",
  "node --no-warnings --test test/provenance-source-assessment.test.mjs",
  "node --no-warnings --test test/provenance-assess-cli.test.mjs",
  "node --test test/update-preview.test.mjs",
  "node --test test/update-preview-brain-adapter.test.mjs",
  "node --test test/update-pending-refusal.test.mjs",
  "node --no-warnings --test test/same-version-paused-resume.test.mjs",
  "node --no-warnings --test test/older-release-paused-resume.test.mjs",
  "node --test test/first-source-file.test.mjs",
  "node --test test/first-source-file-brain-adapter.test.mjs",
  "node test/windows-native-architecture.test.mjs",
  "node --no-warnings --test test/ocr-preflight.test.mjs",
  ...
  "node --no-warnings --test worker/test/identical-content-no-reembed.test.mjs",
  "node --no-warnings --test test/setup-secrets-write-timeout.test.mjs",
  "node test/admin-key-keychain-probe.test.mjs",
