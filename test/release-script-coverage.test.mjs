...
for (const required of ['npm ci --prefix frontend --ignore-scripts', 'npm --prefix frontend test', 'git diff --exit-code -- worker/src/lib/app-assets.js', 'Windows DPAPI 25-round release gate', 'packed Windows DPAPI and admin-key release gate']) {
