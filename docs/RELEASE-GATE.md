...
identity or the retired identities of the held, never-published 0.4.7 and 0.4.8
candidates. The enforcing `scripts/audit-updates.mjs --release` path requires
0.4.9 or newer before any release write. Advisory and local test modes remain usable
